...
namespace GridMvc.Columns
{
    ...
    public class GridColumn<T, TDataType> : GridColumnBase<T> where T : class
    {
        ...
        /// </summary>
        private IColumnFilter<T> _filter;
        ...
        public override bool ResizeEnabled { get; set; }
        ...
        public override IGridCell GetValue(T instance)
        {
            ...
            else
            {
                ...
                if (nullReferece || object.Equals(value, default(TDataType)))
            ...
            return new GridCell(textValue) { Encode = EncodeEnabled, Html = HtmlEnabled };
        }
        ...
        public override IGridColumn<T> Resizable(bool enable)
        {
            if (enable && _constraint == null)
            {
                return this; //cannot enable filtering for column without expression
        ...
        public override IGridColumn<T> MultiCheckboxListFilter(IEnumerable<GridSelectListItem> selectList)
        {
            SetFilterWidgetType("MulticheckboxListWidget", selectList);
            return this;
        }
    }
}