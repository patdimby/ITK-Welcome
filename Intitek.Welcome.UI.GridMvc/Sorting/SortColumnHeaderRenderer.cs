...
namespace GridMvc.Sorting
{
    ...
    {
        private const string SortedButtonCssClass = "fas sorted";
        private const string SortableButtonCss = "fas sortable";
        ...
        protected string GetSortHeaderContent(IGridColumn column)
        {
            ...
            if (column.IsSorted)
            {
                sortTitle.AddCssClass(SortedButtonCssClass);
            ...
            else if (column.SortEnabled)
            {
                var sortArrow = new TagBuilder("span");
                sortTitle.AddCssClass(SortableButtonCss);
                sortTitle.InnerHtml += sortArrow.ToString();
            }
