...
(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      (null === this.options.liveSearchPlaceholder ? '' : ' placeholder="' + htmlEscape(this.options.liveSearchPlaceholder) + '" data-i18n-placeholder="' + htmlEscape(this.options.liveSearchPlaceholder) + '"') + ' role="textbox" aria-label="Search">' +
      '</div>'
          : '';
    ...
    render: function () {
      ...
      //The following line has been commented for functionnality purposes on this Astek project
    ...
    clickListener: function () {
      ...
      function setFocus () {
        if (that.options.liveSearch) {
          if(!that.options.focusOff) that.$searchbox.focus();
        } else {
          that.$menuInner.focus();
        }
      }
